  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full h-screen">
        ...
        {/* <div className="max-w-[600px] w-full bg-white rounded-md absolute top-1/2 left-1/2
         -translate-x-1/2 -translate-y-1/2 overflow-hidden">
          ...
          <div className="modal-main p-2">
            <div className="grid  grid-cols-3 gap-4 h-[60vh] custom-scroll overflow-auto">
              {Array.from(Array(10).keys()).map((i) => (
                <div className="text-center space-y-2" key={i}>
                  ...
                  />
                  <p className="font-bold">Chicken Joy Meal 1</p>
                  <h5>P 150.00</h5>
                  <ul className="flex items-center gap-4 justify-center">
                    <li>
                      <button
                        className="grid size-[30px] place-content-center 
          ...
          <div
            className="modal-summary absolute bottom-0 left-0 w-full p-4 bg-white
          flex justify-between items-center shadow-[0_10px_30px_rgba(0,0,0,_0.4)]"
          >
            <h3 className="mb-0">Total: P 1000.00</h3>
        ...
        {/* <div
          className="max-w-[600px] w-full bg-white rounded-md absolute top-1/2 left-1/2
         -translate-x-1/2 -translate-y-1/2 overflow-hidden"
        >
          <div className="modal-header p-4 flex justify-between items-center border-b border-gray-200">
            <button>
        ...
        {/* <div className="max-w-[600px] w-full bg-white rounded-md absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden">
          ...
          <div className="modal-main h-[60vh] w-full flex justify-center items-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-2xl mb-5 font-bold">Select preferred payments option</p>
